...
pathsByWeight.set("duocolor", (color: string, duocolor: string) => (
  <>
    <circle cx="80" cy="168" r="32" fill={duocolor} />
    <circle cx="80" cy="64" r="32" fill={duocolor} />
    <circle cx="176" cy="168" r="32" fill={duocolor} />
    <circle cx="176" cy="64" r="32" fill={duocolor} />
    <circle
      cx="80"
      cy="168"
      r="32"
